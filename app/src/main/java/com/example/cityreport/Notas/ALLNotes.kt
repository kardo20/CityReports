...
import com.example.cityreport.Notas.adapters.NotasAdapter
import com.example.cityreport.Notas.entities.Nota
import com.example.cityreport.Notas.viewModel.NotaViewModel
import com.example.cityreport.R
import com.google.android.material.floatingactionbutton.FloatingActionButton

class ALLNotes: AppCompatActivity(), NotasAdapter.OnItemClickListener {
    ...
    override fun onItemClick(nota: Nota) {
        ...
        val edit_nota_activity = Intent(this, EditNota::class.java)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode == 2 && resultCode == Activity.RESULT_OK){
            ...
            if(id!=0 && id!=null && edited_nome!=null && edited_descricao!=null){
                ...
                Toast.makeText(applicationContext, "Alteração efetuada com secesso!}", Toast.LENGTH_SHORT).show()
            }
            //Eliminar a Nota
            else if(id!=0 && id!=null && codigo_apagar == 20){
                notaViewModel.deleteByID(id)
                Toast.makeText(applicationContext, "Nota com o ID=${id} apagada com sucesso!", Toast.LENGTH_SHORT).show()
            }
            else{
                Toast.makeText(applicationContext, "Erro na alteração de dados da nota!", Toast.LENGTH_SHORT).show()
            }
        }
